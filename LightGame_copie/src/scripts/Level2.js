...
BasicGame.Level2.prototype = {
	...
	preload: function () {
		...
		this.load.spritesheet('blue_door', 'src/media/img/luming_cyan.png', 32, 32);
		this.load.spritesheet('white_lumming', 'src/media/img/luming_white.png', 32, 32);
		this.load.spritesheet('blue_lumming', 'src/media/img/luming_blue.png', 32, 32);
	...
	create: function () {
		...
		var door;
		{
			door = blue_doors.create(700, 270, 'blue_door');
		}
		...
		var filter;
		{
			filter = blue_filters.create(600, 270, 'blue_filter');
		}
